...
We’ll be working with an example repository, the [ook-translator](https://github.com/almanilsson/ook-translator), on which the tutorial has already been applied. The tutorial can be applied to the original state of the ook-translator, [ook-translator-original](https://github.com/almanilsson/ook-translator-original), it is probably more useful (and way easier) if you apply it to your own repository.

Many researchers hesitate to share their code because they feel it’s “not good enough”, or because it seems like too much work. We’re here to improve and build confidence in sharing. Your code is good enough to be shared and sharing it can help - and will probably motivate you to - improve it. Any small improvement is progress. After all, research is about learning new things and getting better from past mistakes. Today we hope to make that process as easy as possible.

## Task 1: Identify problems (although you can jump to task 2 if you are eager to begin)
...
`<Link related to solving the issue in the example repository>`
